...
\subsection{Metropolis-Hastings algorithm}
	...
	Regardless of this fact let us start with constructing such a matrix. Assume that we have another stochastic matrix $\bfQ$ which is irreducible and aperiodic. Let us consider a matrix defined as:
