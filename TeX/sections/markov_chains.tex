...
\subsection{Definition and basic properties}
	...
	\begin{definition}
		A initial distribution of a Markov chain is a vector $\bfmu = (\mu_1, \ldots, \mu_N)^T \in \R^N$ such that $\sum_{i=1}^{N} \mu_i = 1$. This is a distribution of a random variable $X_0$, which is an initial state of a Markov chain.
	\end{definition}
